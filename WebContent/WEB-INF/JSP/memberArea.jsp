		...
		<div class="container">
			...
			<form role="form" name="selectCity" action="shops" method="get">
				<div class="form-group">
					...
					<input id = "button1" type="submit" class = "btn btn-primary btn-lg" value="Select City &raquo;">
				</div>
			</form>
			<p><a id = "button2" class="btn btn-primary btn-lg" href="location" role="button">  New Location   &raquo;</a></p>
		</div>
	</div>
	</div>
	<hr>
